...
while not done:
    ...
    if circle_x == 0:
        ...
        if pressed[pygame.K_UP]: square_y -= 100
        if pressed[pygame.K_DOWN]: square_y += 100
        if pressed[pygame.K_LEFT]: square_x -= 100
        if pressed[pygame.K_RIGHT]: square_x += 100
        if pressed[pygame.K_UP]: laser_y -= 10
